                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            ...
                            leftovers?: components["schemas"]["Item"][];
                            ...
                            imageScale?: components["schemas"]["Point"];
                            /**
                             * @description if `includeImages` is enabled, `imageScaleStyleUsed` returns the image scaling method used to generate the images. `fill` is default, and `override` means a non-zero `imageScale` was passed in directly to the request and any `imageScaleStyle` was overridden.
                             * @default fill
                             * @enum {string}
                             */
                            imageScaleStyleUsed: "fill" | "largest-box" | "largest-box-type" | "override";
...
export interface components {
    schemas: {
        ...
        Pack: {
             ...
             *     }
             */
            boxTypeDefaults?: components["schemas"]["BoxProperties"];
            /**
             ...
             * @example []
             */
            boxTypeSets?: components["schemas"]["BoxTypeSet"][];
            /**
             ...
             *     }
             */
            packOrigin?: components["schemas"]["Point"];
            /**
            ...
            imageScale?: components["schemas"]["Point"];
            /**
             * @description If desired, a methodology to automatically scale images consistently. Empty or not set is the same as `fill`, which will scale each image to fill the `imgSize` view automatically. `largest-box` will scale all box images to the largest `box` actually used in the pack, and `largest-box-type` will scale all box images to the largest `BoxType` available in the pack (including those generated by a `BoxTypeGenerator`.) `largest-box` is useful if boxes will be visually compared within a single pack, and `largest-box-type` is more usable if pack images are going to be visually compared across boxes and packs. Any non-zero values in `imageScale` will take precedence and disable the `imageScaleStyle`.
             * @default fill
             * @enum {string}
             */
            imageScaleStyle: "fill" | "largest-box" | "largest-box-type";
            /**
        ...
        BoxProperties: {
            ...
            dimensions: components["schemas"]["Point"];
            ...
            outer?: {
                ...
                dimensionChange?: components["schemas"]["Point"];
            };
            /**
            ...
            rateTable?: components["schemas"]["RateTable"];
        ...
        BoxType: components["schemas"]["BoxProperties"];
        /**
         ...
         * @enum {string}
         */
        Metric: "volume" | "surface-area" | "surface-area-rsc" | "longest-dimension" | "middle-dimension" | "shortest-dimension" | "length-plus-girth" | "girth" | "x-dimension" | "y-dimension" | "z-dimension" | "longest-to-middle-ratio" | "longest-to-shortest-ratio" | "middle-to-shortest-ratio" | "z-to-y-ratio" | "z-to-x-ratio" | "y-to-x-ratio";
        /** @description A completed, packed box. */
        Box: components["schemas"]["BoxProperties"] & {
            id?: number;
            subspace?: components["schemas"]["Subspace"];
            boxType?: components["schemas"]["BoxType"];
            /** items */
            items?: {
        ...
        Item: components["schemas"]["ItemProperties"] & {
            ...
            dimensionSet?: components["schemas"]["DimensionSet"];
        };
        /** @description set of items sharing a common type. */
        ItemSet: components["schemas"]["ItemProperties"] & {
            ...
            dimensionSets?: components["schemas"]["DimensionSet"][];
        };
        /**
         * DimensionSet
        ...
        DimensionSet: {
            ...
            axisMultipliers?: components["schemas"]["Point"];
         ...
         */
        BoxMatch: {
            /** @description The `boxType` property to search with the expression. If `name`, it will search the `name` property of the `boxType`, otherwise it will search `boxType` `properties` for any keys matching `property` with string values. */
            property?: string;
        ...
        Rule: {
            ...
            itemMatch?: components["schemas"]["ItemMatch"];
             ...
             * @enum {string}
             */
            operation: "exclude" | "exclude-all" | "pack-as-is" | "irregular" | "lock-orientation" | "internal-space" | "alternate-dimensions" | "fragile" | "set-properties" | "group-pack" | "pack-sequence" | "bounded-fill";
        ...
        Subspace: {
            ...
            originInParent?: components["schemas"]["Point"];
